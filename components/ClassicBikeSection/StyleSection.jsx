...
import classic from '../../public/Classic/classic-black-cropped.webp'
...
const StyleSection = () => {
  return (
    ...
    <h1 className='connectSubText pb-16 xl:pb-20 '>
       With an integrated cockpit and streamlined handlebars, the
       Classic gives you a sporty riding position on a sleek step-over
       frame. Mount up and lean in to move straight through.
    </h1>   
    </div>
    ...
    <p className='absolute top-5 left-[20%] font-sand  font-[500]'>Sport Saddle</p> 
    ...
    <h1 className='web-bike font-rale text-[40px] sm:text-[55px] lg:text-[85px] xl:text-[95px] font-[500] xl:leading-[6.5rem] text-center'>Elevate your ride to meet your style</h1>    
    ...
    <div id='item-classic' className='xl:h-[60vh] overflow-y-hidden relative '>
