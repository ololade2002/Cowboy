...
import img5 from '../../public/Cruiser/standard_resolution1.jpg'
...
const StreetSection = () => {
  return (
    ...
    <ul className="body flex flex-col xl:flex-row gap-6 py-9 xl:py-12">
     ...
     <h1 className='font-rale text-[25px] md:text-[32px] font-[500] text-[#000] leading-10'>See the Cruiser on the streets</h1> 
