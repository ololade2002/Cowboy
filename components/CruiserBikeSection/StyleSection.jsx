...
import classic from '../../public/Cruiser/cruiser-sand-cropped.webp'
import img1 from '@/public/Cruiser/cruiser--detail-4.webp'
import img3 from '@/public/Cruiser/cruiser--detail-5.webp'
import img2 from '@/public/Cruiser/cruiser--detail-3.webp'
...
const StyleSection = () => {
  return (
    ...
    <div className='relative w-[100%]  flex items-center justify-center ' id=''>
    ...
    <li className='web-bike'>
    <p className='absolute top-[29%] right-16 font-sand  font-[500]'>Raised cockpit, curved handlebars</p>
    ...
    <div id='page-cruiser' className='relative w-[100%] rounded-md object-cover'>
    ...
    <li id='page-cruiser' className='w-full xl:w-8/12 h-auto rounded-md relative overflow-y-hidden '>
    ...
    <div id='page-cruiser' className='xl:h-[60vh] overflow-y-hidden relative'>
    ...
    <div className='pt-6 xl:h-[60vh] overflow-y-hidden relativew-[80%] mx-auto'>
