...
const Ebikes = () => {
  ...
  return (
    ...
    <button type="button" onClick={openModal} className="mobilenav-textb m-view flex items-center gap-1">
    ...
    <Dialog.Description>
    <div className='modal  justify-center grid grid-cols-2 md:grid-cols-4 gap-4 xl:gap-4 '>

     <div  onClick={() => router.push('/test-ride')}  className='relative flex flex-col  py-4 px-4 '>
      ...
      <Link href='/test-ride' className='flex-center font-sand text-[18px] hover:underline text-[#1d1d1d] font-[500] gap-1'>Book a test ride <ChevronRightIcon className='w-6 h-6 mt-0.5'/> </Link>
