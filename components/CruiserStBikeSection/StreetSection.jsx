...
import img1 from '../../public/Cruiser-st/standard_resolution3.jpg'
import img2 from '../../public/Cruiser-st/standard_resolution4.jpg'
import img3 from '../../public/Cruiser-st/standard_resolution2.jpg'
import img4 from '../../public/Cruiser-st/standard_resolution5.jpg'
import img5 from '../../public/Cruiser-st/standard_resolution1.jpg'
...
const StreetSection = () => {
  return (
    ...
    <ul className="body flex flex-col xl:flex-row gap-6 py-9 xl:py-12">
     ...
     <h1 className='font-rale text-[25px] md:text-[32px] font-[500] text-[#000] leading-10'>See the Cruiser ST on the streets</h1> 
